...
class ConstrueTableSeeds extends Migration {
    ...
    public function up()
    {
        DB::table('construe_modules')->insert(
                                    array( 
                                            'name'=>'Application', 
        ...
        // DB::table('construe_countries')->insert($construe_countries_rows);

        // $construe_country_languages_rows = array(
        ...
        //                 array('language_id'=>'pt', 'country_id'=>'BR', 'regional_name'=>'Portuguese (Brazil)', 'enabled'=>true, 'created_at' => new DateTime, 'updated_at' => new DateTime),
        ...
        //                 array('language_id'=>'en', 'country_id'=>'US', 'regional_name'=>'English (United States)', 'enabled'=>true, 'created_at' => new DateTime, 'updated_at' => new DateTime),
        ...
        // DB::table('construe_country_languages')->insert($construe_country_languages_rows);


        // $construe_languages_rows = array(
        ...
        // DB::table('construe_languages')->insert($construe_languages_rows);
    ...
    {
        DB::table('construe_modules')->truncate();
        DB::table('construe_countries')->truncate();
        DB::table('construe_country_languages')->truncate();
        DB::table('construe_languages')->truncate();
    }
