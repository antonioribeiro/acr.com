...
class GlottosTableSeeds extends Migration {
    ...
    public function up()
    {
        ...
        // $glottos_country_languages_rows = array(
        ...
        // DB::table('glottos_country_languages')->insert($glottos_country_languages_rows);
    ...
    public function down()
    {
        ...
        DB::table('glottos_country_languages')->truncate();
