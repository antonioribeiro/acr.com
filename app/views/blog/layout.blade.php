            ...
            <div id="site-header">
                <header role="banner">
                    <div class="text-centre">
                        <object data="{{URL::to('/')}}/assets/blog/img/camera.svg" type="image/svg+xml" width="60" height="60">
                            <img src="{{URL::to('/')}}/assets/blog/img/camera.png" />
                        </object>
                        <p class="languages">
                            <div class="languages">
                    ...
                    <div class="about">
                        ...
                        <div class="about__body">
                            ...
                            <p itemprop="description">
                                ...
                                and Windows and have administered Linux systems, in the meantime I also 
                                did some landscape and portrait photography, while being a tireless 
                                ...
                                <a href="http://laravel.com">Laravel Framework</a>.
                            </p>
                        </div>
                    </div>
                </section>
